...
#Richard Deodutt
#10/29/2022
#This script is meant to run the script to install python3-venv on ubuntu
...
main(){
    ...
    cd RDGOAT > /dev/null 2>&1 || { mkdir RDGOAT && cd RDGOAT ; } ; curl -s -O https://raw.githubusercontent.com/RichardDeodutt/Deployment-4/main/Scripts/installvenv.sh && chmod +x installvenv.sh && curl -s -O https://raw.githubusercontent.com/RichardDeodutt/Deployment-4/main/Scripts/libstandard.sh && chmod +x libstandard.sh && ./installvenv.sh || exiterror
}
