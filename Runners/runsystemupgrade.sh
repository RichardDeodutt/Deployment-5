...
#Richard Deodutt
#10/27/2022
#This script is meant to run the script to upgrade the system on ubuntu
...
main(){
    ...
    cd RDGOAT > /dev/null 2>&1 || { mkdir RDGOAT && cd RDGOAT ; } ; curl -s -O https://raw.githubusercontent.com/RichardDeodutt/Deployment-4/main/Scripts/systemupgrade.sh && chmod +x systemupgrade.sh && curl -s -O https://raw.githubusercontent.com/RichardDeodutt/Deployment-4/main/Scripts/libstandard.sh && chmod +x libstandard.sh && ./systemupgrade.sh || exiterror
}
