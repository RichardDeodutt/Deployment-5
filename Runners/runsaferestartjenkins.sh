...
#Richard Deodutt
#10/24/2022
#This script is meant to run the script to safe restart Jenkins on ubuntu
...
main(){
    ...
    cd RDGOAT > /dev/null 2>&1 || { mkdir RDGOAT && cd RDGOAT ; } ; curl -s -O https://raw.githubusercontent.com/RichardDeodutt/Deployment-4/main/Scripts/saferestartjenkins.sh && chmod +x saferestartjenkins.sh && curl -s -O https://raw.githubusercontent.com/RichardDeodutt/Deployment-4/main/Scripts/libstandard.sh && chmod +x libstandard.sh && ./saferestartjenkins.sh || exiterror
}
